    ...
    <div v-else-if="transaction">
      ...
      <div class="card mb-6">
        ...
        <div v-if="transaction.note" class="mt-4">
          <h3 class="text-lg font-semibold text-white mb-2">Note</h3>
          <div class="bg-dark-900 p-3 rounded-lg border border-gray-700">
            <p class="text-gray-300 text-sm break-all">{{ transaction.note }}</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div class="bg-dark-900 p-3 rounded-lg border border-gray-700">
                <p class="text-purple-400 font-medium text-lg">
                  {{ transaction["application-transaction"]["application-id"] || "Create New" }}
                </p>
              </div>
            </div>
            <div>
