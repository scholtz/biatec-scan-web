...
const getApiPoolPoolAddress = (
    poolAddress: string,
 ) => {
      return axiosInstance<Pool>(
      {url: `https://algorand-trades.de-4.biatec.io/api/pool/${poolAddress}`, method: 'GET'
    },
      );
    }
...
return {getApiIndexerStatus,getApiPool,getApiPoolPoolAddress,getApiPoolStats,getApiSignalrAuthTest,getApiSignalrAuthTestAuthorized,postApiSignalrTestBroadcast,postApiSignalrTestTrade,getApiSignalrConnections}};
...
export type GetApiPoolPoolAddressResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getAVMTradeReporterAPI>['getApiPoolPoolAddress']>>>
